...
{
    $connect = new mysqli('damianspa.com.pl','00315054_zadanie7','Damixd1998.','00315054_zadanie7');
        ...
        if($person['nick'] == $nick && $person['haslo'] == $haslo){
            ...
            if($Query -> num_rows != 0){
                ...
                if($next_fail == 0){
                    ...
                    echo "Konto zostało zablokowane na 2 minuty";
                }
                else{
